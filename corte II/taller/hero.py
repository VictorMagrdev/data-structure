from sll_hero import SingleLinkedList
class Superhero:
    def __init__(self):
        self.all_heroes = SingleLinkedList()
    ...
    def add_hero(self):
            ...
            superpoderes =[]
            creador = []
            desicion = input('Desida el univero: \n M marvel o D dc\n')
            ...
            hero = (self.universo[editorial], nombre.capitalize() , superpoderes , creador)
            self.all_heroes.create_node_sll_ends(hero)
