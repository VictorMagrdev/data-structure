...
for i in range(50):
    try:
        ...
        # Generar grupos y comunidades para el usuario
        ...
        num_communities = random.randint(1, 4)  # Número aleatorio de comunidades (puede ser de 1 a 4)
        user_communities = random.sample(community_names, num_communities)  # Seleccionar nombres aleatorios de comunidades
